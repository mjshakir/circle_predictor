...
class RLGenerate : protected Generate{
    //--------------------------------------------------------------
    public:
        //--------------------------------------------------------------
        RLGenerate(void) = delete;
        //--------------------------
        // RLGenerate(const INPUT& input) : m_input(input){
        //     //--------------------------
        // }// end RLGenerate(const INPUT& input) : m_input(input)
        //--------------------------
        // RLGenerate(INPUT&& input) : m_input(std::move(input)){
        //     //--------------------------
        // }// end RLGenerate(const INPUT& input) : m_input(input)
        //--------------------------
        RLGenerate( const double& radius = 1, 
