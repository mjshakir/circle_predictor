...
//--------------------------------------------------------------
double RLEnvironment::internal_reward_function(const torch::Tensor& real_value, const torch::Tensor& predicted_value, const long double& tolerance) const{
    //--------------------------
...
//--------------------------------------------------------------
std::tuple<torch::Tensor, double, bool> RLEnvironment::internal_step_function(const torch::Tensor& actions, const long double& tolerance){
    //--------------------------
    ...
    //--------------------------
}// end std::vector<std::tuple<torch::Tensor, double>> RLEnvironment::internal_step_function()
//--------------------------------------------------------------