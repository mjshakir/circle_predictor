    ...
    namespace Environment {
        ...
        class RLEnvironmentLoader : public RLEnvironment<T, COST_OUTPUT, Args...>{
            ...
            public:
                ...
                */
                explicit RLEnvironmentLoader(   const std::span<T>& data, 
                ...
                //--------------------------------------------------------------
                RLEnvironmentLoader(const RLEnvironmentLoader&)            = default;
                RLEnvironmentLoader& operator=(const RLEnvironmentLoader&) = default;
                //----------------------------
                RLEnvironmentLoader(RLEnvironmentLoader&&)                 = default;
                RLEnvironmentLoader& operator=(RLEnvironmentLoader&&)      = default;
                //--------------------------------------------------------------
                /**
            ...
            protected:
                //--------------------------------------------------------------
                using RLEnvironment<T, COST_OUTPUT, Args...>::internal_step;  // Bring base class functions into scope
                //--------------------------
                using RLEnvironment<T, COST_OUTPUT, Args...>::get_first_internal;  // Bring base class functions into scope
                //--------------------------------------------------------------
